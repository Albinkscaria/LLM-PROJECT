...
#Memory mapping for using small snippets of text from a single file  of any size
def get_random_chunk(split):
    filename = "openwebtext/train_split.tokens" if split == 'train' else "openwebtext/valid_split.tokens"
    with open(filename, 'rb') as f:
        with mmap.mmap(f.fileno(), 0,access=mmap.ACCESS_READ) as mm:
            ...
            #Decode the block to a string, ignroing any invalid byte  sequences
